...
$jobTeaserImporter = new JobTeaserImporter(SQL_HOST, SQL_USER, SQL_PWD, SQL_DB, RESSOURCES_DIR . 'jobteaser.json');
$count = $jobTeaserImporter->importJobs();

printMessage("> {count} jobs from JobTeaser imported.", ['{count}' => $count]);
